...
if("TRUE" STREQUAL "TRUE")
  set(ik_SOURCE_PREFIX /home/cc/ee106a/fa18/class/ee106a-aay/ros_workspaces/lab5/src/ik)
  set(ik_DEVEL_PREFIX /home/cc/ee106a/fa18/class/ee106a-aay/ros_workspaces/lab5/devel)
  set(ik_INSTALL_PREFIX "")
  set(ik_PREFIX ${ik_DEVEL_PREFIX})
else()
  set(ik_SOURCE_PREFIX "")
  set(ik_DEVEL_PREFIX "")
  set(ik_INSTALL_PREFIX /home/cc/ee106a/fa18/class/ee106a-aay/ros_workspaces/lab5/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-aay <ee106a-aay@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa18/class/ee106a-aay/ros_workspaces/lab5/src/ik/${idir}'.  Ask the maintainer 'ee106a-aay <ee106a-aay@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106a/fa18/class/ee106a-aay/ros_workspaces/lab5/devel/lib;/home/cc/ee106a/fa18/class/ee106a-aay/ros_workspaces/lab5/devel/lib;/home/cc/ee106a/fa18/class/ee106a-aay/ros_workspaces/lab4/devel/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/indigo/lib)
